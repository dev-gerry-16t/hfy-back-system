const GLOBAL_CONSTANTS = {
  ...
  STRIPE_WEBHOOK_SUBSCRIPTION_SECRET:
    process.env.STRIPE_WEBHOOK_SUBSCRIPTION_SECRET,
  WEBHOOK_PASS_ML_DB: process.env.WEBHOOK_PASS_ML_DB,
  PATH_FRONT_URL: process.env.PATH_FRONT_URL,
  KEY_MANDRILL: process.env.KEY_MANDRILL,
  WEBHOOK_PASS_MANDRILL: process.env.WEBHOOK_PASS_MANDRILL,
};
